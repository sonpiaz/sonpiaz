...
I build tools at the intersection of **AI agents** and **developer productivity**.

Founder of [Affitor](https://affitor.com) — an AI-native affiliate marketing platform for SaaS companies.
...
| Project | Description | |
|---------|-------------|-|
| [**open‑affiliate**](https://github.com/Affitor/open-affiliate) | Open registry of 750+ affiliate programs. CLI, MCP server, SDK, REST API. | ![Stars](https://img.shields.io/github/stars/Affitor/open-affiliate?style=flat) |
